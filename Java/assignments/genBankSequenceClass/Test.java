...
/**
 * A main class to intialize GenBankSequence objects and test the execution time
 * of repeated sequence concatenations using the concatate() method.
 */
public class Test {
    public static void main(String[] args) {

        // Variables -----------------------------------------------------------
        GenBankSequence test = new GenBankSequence();
        ...
        String typeObject = "GenBankSequence"; // To generalize the print statements
