...
/**
 * A main class to intialize StringBuilderGenBankSeq objects and test the
 * execution time of repeated sequence concatenations using the concatate()
 * method.
 */
public class TestStringBuilder {
    public static void main(String[] args) {
        ...
        // Variables -----------------------------------------------------------
        StringBuilderGenBankSeq test = new StringBuilderGenBankSeq();
        ...
        String typeObject = "StringBuilderSeq"; // To generalize the print statements

        // Running testConcatenate() for five files ---------------------------
        for (int i = 0; i < 5; i++) {
